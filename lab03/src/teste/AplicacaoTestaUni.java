...
/*
* OBS: Não foram implementados os testes associados ao tamanho da turma
* (5 <= turma <= 35) e ao número de monitores (0 <= monitores <= 3) para
* que se pudesse ver algum efeito na execução. A maneira que a aplicação
* base foi construída "impede" a execução completa do código. Os testes
* estão comentados no arquivo Turma.java.
*/
